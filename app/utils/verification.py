    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <p>We received a request to reset your password for your MovieFusion account.</p>
                ...
                <a href="{reset_link}" class="link">Reset Password</a>

                <p>This link is valid for 15 minutes. If you don't reset your password within this time, you can request a new password reset.</p>
